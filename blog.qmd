...
*Takeaway: Checking high loss data points on a large, pre-trained language model can be useful as a quick and easy data quality health check, or for more rigorous data cleansing.*
...
However, the majority of studies only uses simple artificial noise, in which labels are randomly flipped with no regard to the input text.
